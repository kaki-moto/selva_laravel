    ...
    @if($products->count())
        <table border="1" width="100%">
            <tr>
                <th bgcolor="gray">
                    ID
                    <a href="{{ route('admin.productList', ['sort' => 'id', 'direction' => $direction == 'asc' ? 'desc' : 'asc', 'search_id' => $searchId, 'search_keyword' => $searchKeyword]) }}">
                    {{ $sort == 'id' ? ($direction == 'asc' ? '▼' : '▲') : '' }}
                    </a>
                </th>
                <th bgcolor="gray">
                    商品名
                    <a href="{{ route('admin.productList', ['sort' => 'name', 'direction' => $direction == 'asc' ? 'desc' : 'asc', 'search_id' => $searchId, 'search_keyword' => $searchKeyword]) }}">
